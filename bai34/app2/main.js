// Tại sao nên sử dụng 'const' thay vì 'let' cho đối tượng trong JS?
// Ôn tập
...
// Và tất nhiên chúng ta vẫn thêm, sửa, xóa thuộc tính bình thường, chỉ là 0 ghi đè được lại đối tượng đã khai báo
